...
class _MovementCardDialogState extends State<MovementCardDialog>
  ...
  void _onSave() {
    ...
    if (_esSerie) {
      if (periodoText.isEmpty || hastaPeriodoText.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
                'Para series, debes especificar el período inicial y final'),
    ...
    if (_esSerie &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('El período final debe ser mayor que el inicial'),
          backgroundColor: Colors.red,
        ),
      );
      return;
